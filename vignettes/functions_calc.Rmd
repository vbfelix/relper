...
The Biserial correlation coefficient is a measure of the correlation between a continuous variable and a binary variable. It uses the same formula as the Pearson correlation.
...
-   $x_i$ is a numeric vector og length $n$;
