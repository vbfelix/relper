...
The goal of `calc_combination` is to compute the number of combinations/permutations. Considering that we have a total of $n$ observations and that $r$ will be selected.
...
## Order does not matters with repetition
...
## Order does not matters without repetition
