---
title: "stat_functions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{stat_functions}
...
`stat_` functions apply statistical tests and show the results in an table.
...
![Result of the function stat_two_cat.](stat_two_cat.png)
...
![Result of the function stat_two_num.](stat_two_num.png)
