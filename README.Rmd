...
In the function above we use a .png file already imported in the R environment, but it is also possible to import a local file, providing the argument `png_filepath` instead.
