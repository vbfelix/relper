...
gt::gtsave(png_tbl_two_cat, "png_tbl_two_cat.png",
...
The goal of **tbl_two_num** is to create a summary table comparing on or more numerical variables between two groups.
