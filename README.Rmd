...
```{r,echo = F}
ggplot(data = tibble(x = x),aes(x))+
  geom_density()+
  geom_vline(xintercept = num_mode(x),col = "royalblue4", size = 1)+
  theme_y()+
  scale_x_continuous(breaks = 0:20,sec.axis = sec_axis(~.,breaks = round(num_mode(x),2)))
